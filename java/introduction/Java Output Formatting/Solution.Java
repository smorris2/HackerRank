public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hello, World."); //add for "Hello, World."
        System.out.println("Hello, Java.");  // add for "Hello, Java."
    }
}


//Task: print out a simple "hello world" prompt 
//
//A simple task enough. Pre-made task does not include the last
//
...
// * printf  - also can be called with System.out.format(). 
//
//
//format specifiers:
// %c - character
